    ...
    <>
      <div className="mt-20">
        ...
        <div className="packageContainer max-w-[890px] mx-auto grid gird-cols-1 sm:grid-cols-2  md:grid-cols-3 gap-5 ">
          {subPackage.map((data) => {
            const isPurchased = user?.packageLimit >= data.employeeLimit;
            return (
              <div
                key={data._id}
                  ...
                  <div className="text-center mt-2">
                    {
                      ...
                      className="py-1 px-2 lg:py-1 lg:px-4 rounded-[10px] text-[12px] lg:text-[18px] font-medium cursor-none mt-3 "
                    >
                      Active Plan
                    </button>:<button
